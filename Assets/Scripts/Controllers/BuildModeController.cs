...
public class BuildModeController : MonoBehaviour {
	...
	public string buildModeObjectName;
	...
	public bool IsObjectDraggable() {
		...
		Furniture proto = WorldController.Instance.world.furniturePrototypes[buildModeObjectName];
	...
	public void SetMode_BuildFurniture(string objectName) {
		// Wall is not a Tile!  Wall is an "Furniture" that exists on TOP of a tile.
		buildMode = BuildMode.FURNITURE;
		buildModeObjectName = objectName;
		GameObject.FindObjectOfType<MouseController>().StartBuildMode();
	}
	...
	public void DoBuild(Tile t) {
		if (buildMode == BuildMode.FURNITURE) {
			...
			string furnitureType = buildModeObjectName;
